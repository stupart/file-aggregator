...
electron_1.ipcMain.handle('save-config', function (_, config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                configPath = path.join(electron_1.app.getPath('userData'), 'exclusion-config.json');
...
electron_1.ipcMain.handle('load-config', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                _a = _b.sent();
                return [2 /*return*/, DEFAULT_EXCLUSION_CONFIG];
